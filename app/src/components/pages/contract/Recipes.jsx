		...
		steps: [
			{
				...
				time: "60 minut",
				description: "Gotuj wodę i dodaj składniki, aby przygotować brzeczkę.",
				ingredients: [
			...
			},
			{
				...
				time: "10-14 dni",
				description: "Przenieś brzeczkę do fermentora i pozostaw do fermentacji.",
				ingredients: [
			...
			},
			{
				...
				time: "1-2 godziny",
				description: "Zabutelkowanie piwa i dodanie cukru do refermentacji.",
				ingredients: [
			...
			},
			{
				...
				time: "1-2 tygodnie",
				description: "Pozostaw piwo w butelkach do pełnego dojrzenia.",
				ingredients: [
					{ name: "Piwo w butelkach", amount: "20L" },
				],
			},
		],
	}];
