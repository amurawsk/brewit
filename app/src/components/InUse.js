...
const InUse = () => {
    ...
    const in_use = [
        {
            name: 'Tank warzelny #1',
            type: 'Tank warzelny',
            serial_number: '123456',
            capacity: '100L',
            temperature_range: '80C-120C',
            sour_beers: 'tak',
            price: '300zł/h',
            carbonation: '-',
        ...
        {
            name: 'Pojemnik fermentacyjny #1',
            type: 'Pojemnik fermentacyjny',
            serial_number: '234567',
            capacity: '100L',
            temperature_range: '10C-30C',
            sour_beers: 'tak',
            price: '300zł/h',
            carbonation: '-',
            supported_containers: '-',
        ...
        {
            name: 'Kocioł do leżakowania #1',
            type: 'Kocioł do leżakowania',
            serial_number: '345678',
            capacity: '100L',
            temperature_range: '-5C-20C',
            sour_beers: 'nie',
            price: '300zł/h',
            carbonation: 'mieszanka CO2/N2',
            supported_containers: '-',
        },
        {
            name: 'Urządzenie do rozlewania #1',
            type: 'Urządzenie do rozlewania',
