...
const RegisterUser = () => {
	...
	return (
    	<div className="register_user" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
			<button onClick={handleLogout} style={{ alignSelf: 'flex-end'}}>Wyloguj</button>
			<h1>Witaj w rejestracji użytkowników!</h1>
				<p>Opis</p>
				<form onSubmit={goBack} style={{ display: 'flex', flexDirection: 'column', textAlign: 'right', padding: '20px' }}>
