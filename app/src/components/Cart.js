...
const Cart = () => {
    ...
    const timeslots = [
        {
            type: 'Tank warzelny',
            start: '29.11.2024, 11:00',
            end: '29.11.2024, 16:00',
        },
        {
    ...
    return (
        <div
            ...
            <form
                ...
                <div style={{ padding: '10px' }}>
                    <label for="volume">
                        <b>Objętość produkowanego piwa: </b>
                    </label>
                    <input
                        type="text"
                        placeholder="Wpisz objętość piwa"
