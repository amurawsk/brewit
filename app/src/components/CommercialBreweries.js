...
const CommercialBreweries = () => {
    ...
    const breweries = [
        {
            brewery_name: 'Zrób u nas piwo',
            address: 'ul. Piwna 19, Warka, 05-660',
            contact_phone_number: '123456789',
            contact_email: 'zrobunaspiwo@hotmail.com',
            nip: '1234567890',
        },
    ];
    ...
    return (
        <div
            className="commercial_breweries"
            style={{
                display: 'flex',
