                    ...
                    <div className={styles.panel}>
                        <div className={styles.header}>
                            ...
                            <div className={styles.right}>
                                Status: {
                                    order.status === 'C' ? <span className={styles.current}>Aktualne</span> :
                                    order.status === 'N' ? <span className={styles.pending}>Oczekujące</span> :
                                    order.status === 'P' ? <span className={styles.past}>Przeszłe</span> :
                                    order.status === 'R' ? <span className={styles.rejected}>Odrzucone</span> :
                                    'Nieznany status'
                                }
                            </div>
                        </div>
                        ...
                        <div className={styles.details}>
                            <div className={styles.detailBox}>
                                <h3>Zleceniodawca</h3>
                                <p>Nazwa browaru: {order.contract_brewery_name}</p>
                                <p>Właściciel: {order.contract_brewery_owner_name}</p>
                                <p>Email: {order.contract_brewery_email}</p>
                                <p>Numer telefonu: {order.contract_brewery_phone_number}</p>
                            </div>
                            <div className={styles.detailBox}>
                                <h3>Informacje</h3>
