...
const AddRecipeForm = ({ recipe, isEditing }) => {
	...
	const handleAddEditIngredient = (newIngredient, ingredientId, stepIndex) => {
	...
	const handleDeleteIngredient = (stepIndex, ingredientId) => {
		setformData((prevState) => {
			...
			updatedSteps[stepIndex].ingredients = updatedSteps[stepIndex].ingredients.filter(
				(_, index) => index !== ingredientId
			);
			return {
				...prevState,
				steps: updatedSteps,
    ...
    return (
        <div>
            ...
            {formData && !isEditingRecipe && !isEditingStep && !isEditingIngredient && (
            ...
            {formData.steps.length > 0 && (
                <StepsList
					...
					handleCancelAddEditIngredient={handleCancelAddEditIngredient}
