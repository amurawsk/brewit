...
const AddRecipeForm = () => {
    ...
    const [currentEditingStepIndex, setCurrentEditingStepIndex] =
        useState(null);
    ...
    const handleEditIngredient = (stepIndex, ingredientIndex) => {
        const ingredientToEdit =
            formData.steps[stepIndex].ingredients[ingredientIndex];
                            ...
                            {showIngredientForm === index && (
                                <div className={styles.addDeviceForm}>
                                    ...
                                    <button
                                        className={styles.insertDeviceButton}
                                        onClick={() =>
                                            addIngredient(showIngredientForm)
                                        }>
                                        {deleteId !== null
                                ...
                                currentEditingStepIndex === index && (
                                    <div className={styles.addDeviceForm}>
                                        ...
                                        <select
                                            ...
                                            <option value="Urządzenie A">
                                                Urządzenie A
                                            </option>
                                            <option value="Urządzenie B">
                                                Urządzenie B
                                            </option>
                                        </select>
                                        <label
